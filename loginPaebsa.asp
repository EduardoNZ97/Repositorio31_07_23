...
<!-- Agregar boostrap -->
	...
	$(document).ready(function () 
	{
		...
		$('.create-user').on('click',function(eEvento){
			$("#dialog-form").dialog("option","position",[event.offsetX="center", event.offsetY="center"]); // esta linea centra el dialog cada vez que abre
	...
	<div class="recibo">
		<div class="encabezado">   		
		 <div class="imagen"><img src="imagenes2/servicioConsulta.png" alt="PAEBSA">	</div>	
			<div class="serviciosTitulo2"><h2 data-i18n="sistema.titulo"><strong>Servicio de Bur&oacute Electr&oacutenico "Proveedores"</strong></h2>
...
<ul class="ullisat">
  <li class="lilista"><a class="active alista" href="#home">Nuevas funciones del portal</a></li>
   <li class="lilista">
	    <a class="active alista" aria-current="page" href="loginPaebsa.asp?ln=<%=lg%>" >Consulta general</a>
   </li>
   <li class="lilista">
	    <a href="InfoReceivedSupplier.asp?ln=<%=lg%>" class="active alista" aria-current="page" >Informaci&oacuten enviada a clientes </a></li>
	</li>
</ul>
...
<nav class="navbar navbar-expand-lg" style="background-color:blue;">
  <div class="container-fluid">
    <a class="navbar-brand">Nuevas funciones del portal</a>
    ...
    <li class="nav-item">
	    <a class="nav-link active" aria-current="page" href="loginPaebsa.asp?ln=<%=lg%>" >Consulta general</a>
   </li>
    <li class="nav-item">
	    <a href="InfoReceivedSupplier.asp?ln=<%=lg%>" class="nav-link active" aria-current="page" >Informaci&oacuten enviada a clientes </a></li>
	</li>
    <li class="nav-item dropdown">
		<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Administre su cuenta</a>
			<ul class="dropdown-menu">
				<li><a href="RegistroUsuarios.asp?ln=<%=lg%>" class="dropdown-item" data-i18n="menu.administrarCuenta.usuarios">Administre sus usuarios</a></li>
				<li><a href="CambioPassword.asp?ln=<%=lg%>" class="dropdown-item" data-i18n="menu.administrarCuenta.contrasena">Cambiar contraseña</a></li>
				<li><a href="#" id="modal" class="dropdown-item" onClick="ventanaHistorial();" data-i18n="menu.administrarCuenta.historial">Historial de usuarios</a></li>
			</ul>
	</li>
     </ul>     
    </div>
				...
				<li id="composebtn">
						...
						<li class="has-sub"><a href="#" data-i18n="menu.addendas">&raquo; Captura de Adendas</a>
							<ul>
								...
								<!--Inicia Addenda SORIANA ADMIN -->
								 <!--.functions.asp-->
							    <li class="has-sub"><a href="#" >&raquo;Addendas SORIANA</a>
									<ul>
										<li>
											<%
												Call Addenda_SORIANA_Ext(pass,user,"",Nombre,"loginPaebsa.asp?ln="&lg,"ADMIN")
											%>
										</li>
									</ul>
								</li>        
								<!--Termina Addenda SORIANA ADMIN-->
